const fields = /** @type {Record<String, Partial<HTMLElement & { elements: MockField[] }>>} */ ({
	age: {
		name: 'age',
		placeholder: '18',
		tagName: 'INPUT',
...
/** @typedef {typeof fields} Elements */
/** @typedef {Elements[keyof Elements]} Prop */

/** @type {typeof MockField & Prop} */
